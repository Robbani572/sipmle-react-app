...
const Price = ({price}) => {
    return (
        <div className="mt-12 bg-gray-600 rounded-md p-5 text-white flex flex-col">
            ...
            <button className="w-full p-2 font-semibold rounded-md mt-auto bg-white text-black">Buy Now</button>
        </div>
    )
};
